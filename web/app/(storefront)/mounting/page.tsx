...
export const metadata: Metadata = {
  title: "Шиномонтаж в СПб — цены | TireStock",
  description:
    "Комплексный шиномонтаж легковых автомобилей и кроссоверов на оборудовании Hofmann. Петровская коса. Скидка 15% при покупке шин в нашем магазине.",
};
