...
export const metadata: Metadata = {
  // Мета перенесена со старого сайта tirestock.ru/mounting/ (правка сеошника #2).
  title: "Шиномонтаж - цены в Санкт-Петербурге, сезонная замена шин",
  description:
    "Профессиональный шиномонтаж на оборудовании Hofmann, выгодные цены, высокое качество сервиса.",
};
